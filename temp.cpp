...
Object* method_Function_print (Object* self, Object* p0);
Object* method_Function_tan (Object* self, Object* p0);
...
Object* createVoid () {
   ...
   add_attr(obj, "parent_type0", "Void");
   add_attr(obj, "parent_type1", "Object");
...
Object* createFunction () {
   ...
   add_attr(obj, "parent_type0", "Function");
   add_attr(obj, "method_Function_print", *method_Function_print);
   add_attr(obj, "method_Function_tan", *method_Function_tan);
...
Object* createVector () {
   ...
   add_attr(obj, "parent_type0", "Vector");
   add_attr(obj, "method_Vector_next", *method_Vector_next);
   add_attr(obj, "method_Vector_size", *method_Vector_size);
   add_attr(obj, "method_Vector_current", *method_Vector_current);
   add_attr(obj, "parent_type1", "Object");
...
Object* createSuperman () {
   ...
   add_attr(obj, "parent_type0", "Superman");
   add_attr(obj, "parent_type1", "Object");
...
Object* createBird () {
   ...
   add_attr(obj, "parent_type0", "Bird");
   add_attr(obj, "parent_type1", "Object");
...
Object* createPlane () {
   ...
   add_attr(obj, "parent_type0", "Plane");
   add_attr(obj, "parent_type1", "Object");
...
object* let_0262f9bb (); {
   object* v_7a38d8cb = copy_object(create_vector(3, create_number(1), create_number(2), create_number(3)));
      return func_print(copy_object(   create_number(4)));
}
...
Object* method_Function_tan (Object* self, Object* p0) {
   if(self == NULL)
      ...
      return perform_numeric_operation(func_sin(copy_object()),func_cos(copy_object()),"div");
}
...
Object* method_Vector_current (Object* self) {
   if(self == NULL)
      ...
      return create_vector(3, create_number(1), create_number(2), create_number(3));
}
